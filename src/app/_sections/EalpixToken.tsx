  ...
  return (
    <div className="flex flex-col px-10 lg:px-20 pb-10" id="token">
      <div className="flex flex-row gap-6 justify-center">
        ...
        <h3 className="text-4xl text-primary-text-color font-bold">
          Token Ealpix
        </h3>
      </div>
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10">
        ...
        <div className="flex flex-col">
          ...
          <p className="mt-3 lg:mt-6 text-secondary-text-color text-sm lg:text-xl font-normal text-justify">
            ...
            parent maka anda bisa terhubung langsung dengan perangkat anak anda
            dan memberikan Anda izin penuh untuk menjelajahi kemampuan canggih
            tanpa ribet. Ini seperti memiliki remote kontrol eksklusif yang
            hanya Anda miliki, yang bisa membuat Anda merasa lebih terkendali
            dan aman.
          </p>
        </div>
      </div>
      <div className="relative mt-10 w-full rounded-2xl lg:rounded-3xl bg-gradient-to-b from-primary-color to-primary-linear-color">
        ...
        <div className="mt-10 flex justify-center">
          <p className="relative bg-white rounded-[40px] py-2 px-6 w-fit text-primary-13-color text-center text-base lg:text-2xl font-medium">
            Cara top-up token Ealpix
          </p>
        </div>
        <div className="relative flex flex-col lg:flex-row justify-center lg:justify-evenly lg:space-x-4 pt-10 pb-10 sm:px-20 sm:gap-10">
      ...
      <div className="mt-10">
        ...
        <div className="mt-6 flex flex-col">
          ...
          <p className="mt-3 text-secondary-text-color text-sm lg:text-xl font-normal text-justify">
            ...
            pembayaran dan disini anda dapat memilih untuk membayar menggunakan
            bermacam-macam metode pembayaran.
          </p>
        </div>
        <div className="mt-6 flex flex-col">
          <h3 className="text-primary-text-color text-base lg:text-lg font-medium">
          ...
          <p className="mt-3 text-secondary-text-color text-sm lg:text-xl font-normal text-justify">
            Setelah pembayaran berhasil, Anda akan kembali ke halaman Top Up dan
            bukti pembelian akan muncul pada layar Anda. Token Ealpix yang Anda
            beli akan langsung masuk ke akun Anda dan siap digunakan.
          </p>
        </div>
      </div>
    </div>
