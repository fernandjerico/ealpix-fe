      ...
      <div className="lg:mt-10 sm:mt-6 lg:w-full flex lg:flex-row sm:flex-col lg:gap-10 sm:gap-6">
        ...
        <div className="lg:w-5/6 sm:w-full">
          <p className="lg:text-xl md:text-base sm:text-sm text-justify font-normal text-primary-text-color">
            Melacak anak-anak Anda di mana saja dan kapan saja. Lacak anak Anda
            secara real-time dan ketahui keberadaan mereka. Ealpix meningkatkan
            teknologi pelacakan lokasi sehingga orang tua dapat dengan cepat
            mengonfirmasi lokasi anak mereka. Temukan mereka jika berada dalam
            bahaya, atau intervensi jika mereka memasuki tempat asing atau
            berbahaya. Gunakan Ealpix untuk mengeksplorasi fitur Pelacak Lokasi
            lebih lanjut.
          </p>
        </div>
      </div>
