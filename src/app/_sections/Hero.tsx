      ...
      <div className="relative px-12">
        ...
        <Maxwidthdiv>
          <div className="relative z-1 flex flex-col items-center w-full h-full">
            ...
            <p className="font-sans mt-3 text-primary-text-color text-center sm:text-sm lg:text-base xl:text-lg">
              Awasi anak anda dengan yang terpercaya dan efektif
            </p>
            <a
              href="#"
              className="mt-10 flex gap-2 rounded px-6 py-2 bg-primary-color text-base xl:text-lg">
